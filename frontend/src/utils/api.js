...
export const getProductBySlug = (slug) => api.get(`${PRODCUT_ROUTES}/${encodeURIComponent(slug)}`)
export const getRelatedProducts = (slug) => api.get(`${PRODCUT_ROUTES}/${encodeURIComponent(slug)}/related`)
